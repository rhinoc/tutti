...
func TestClaudeProviderFailureClassification(t *testing.T) {
	tests := []struct {
		...
		{name: "insufficient account balance", code: "authentication_failed", status: 403, message: "Failed to authenticate. API Error: 403 Insufficient account balance", wantCode: "billing_error", wantImpact: providerFailureAuthNone},
